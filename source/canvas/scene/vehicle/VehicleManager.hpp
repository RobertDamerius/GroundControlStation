...
class VehicleManager {
    public:
         ...
         */
        void SetPolygons(const VehicleID& id, const uint8_t segmentIndex, const uint8_t maxSegmentIndex, std::vector<std::vector<std::array<double, 2>>>& polygons, std::vector<std::array<double, 3>> velocities);
         ...
         *  @param [in] shader The vehicle shader.
         */
