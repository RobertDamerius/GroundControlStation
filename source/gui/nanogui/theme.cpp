...
GUI_RESOURCE_EXTLD(source_gui_resource_entypo_bin)
GUI_RESOURCE_EXTLD(source_gui_resource_roboto_regular_bin)
GUI_RESOURCE_EXTLD(source_gui_resource_roboto_bold_bin)
...
Theme::Theme(NVGcontext *ctx) {
    ...
    mTextColor                        = Color(200, 200, 200, 255);
    ...
    mFontNormal = nvgCreateFontMem(ctx, "sans", (unsigned char*)GUI_RESOURCE_LDVAR(source_gui_resource_roboto_regular_bin), (int)GUI_RESOURCE_LDLEN(source_gui_resource_roboto_regular_bin), 0);
    mFontBold = nvgCreateFontMem(ctx, "sans-bold", (unsigned char*)GUI_RESOURCE_LDVAR(source_gui_resource_roboto_bold_bin), (int)GUI_RESOURCE_LDLEN(source_gui_resource_roboto_bold_bin), 0);
    mFontIcons = nvgCreateFontMem(ctx, "icons", (unsigned char*)GUI_RESOURCE_LDVAR(source_gui_resource_entypo_bin), (int)GUI_RESOURCE_LDLEN(source_gui_resource_entypo_bin), 0);
